...
//adding the subsystem with the controller to make it work 
  ...
  private void configureBindings() {
    ...
    new Trigger(m_exampleSubsystem::exampleCondition)
        ...
        //ignore this^ it just runs ExampleCommand when exampleCondition returns true which does nothing
   ...
   new Trigger(() -> m_driverController.getRightX()>0.1 || m_driverController.getLeftY()<0.1).onTrue(new Spin(m_TankDrive));
